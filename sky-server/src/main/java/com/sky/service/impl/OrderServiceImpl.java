...
/**TODO 个人商户没有支付功能
     ...
     * @return
     */
    public PageResult PageList(OrdersPageQueryDTO ordersPageQueryDTO) {
        // 设置分页
        ...
        // 分页条件查询
        Page<Orders> page = orderMapper.selectPageList(ordersPageQueryDTO);
    ...
    public void repetition(Long id) {
     ...
     /*   //将订单详细中的数据赋值给购物车
        ...
        List<ShoppingCart> shoppingCartList = orderDetails.stream().map(x -> {
            ...
            BeanUtils.copyProperties(x, shoppingCart, "id");//忽视id
            shoppingCart.setUserId(userId);
